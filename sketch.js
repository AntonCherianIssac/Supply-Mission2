...
function setup() {
	...
	ground = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:true} );
	 ...
	 boxside2=Bodies.rectangle(width/2-100,600,20,100,{isStatic:true});
	 World.add(world,boxside2);

	 boxside3=Bodies.rectangle(width/2+100,600,20,100,{isStatic:true});
...
function draw() {
  ...
  drawSprites();
   fill("red");
  rect(boxside1.position.x,boxside1.position.y,200,20);
  rect(boxside2.position.x,boxside2.position.y,20,100);
  rect(boxside3.position.x,boxside3.position.y,20,100);
